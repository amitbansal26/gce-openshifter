...
, the number of occurrences of VMs to be created and finally the SSH keys to be imported within the VM

Remark: In order to create several instances or VMS, please verify under the https://console.cloud.google.com/iam-admin/quotas[quotas] that you can assign more than 1 IP Address, that you have enough networks
